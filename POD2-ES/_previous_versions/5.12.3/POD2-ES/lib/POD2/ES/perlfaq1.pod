...
del archivo README de la distribución del código fuente de perl. En L<perlhist>
...
desbordamiento del búfer y, en algunos casos, notificaciones del CERT (por ejemplo,
...
versión principal incorpora diferencias importantes que no son compatibles 
...
versiones más recientes de Perl 5, y algunos módulos de Perl 5 le permiten usar 
la sintaxis de Perl 6 en sus programas. Puede obtener más información sobre 
Perl 6 en http://dev.perl.org/perl6/.
...
subprocesos, o aplicaciones extremadamente grandes. Notará que perl no está 
programado en Perl.
