...
Perl e incluye referencias a documentación adicional.  Es una guía de
iniciación para los nuevos usuarios del lenguaje que proporciona la información
necesaria para poder leer el código Perl de otras personas y comprender a
grandes rasgos su funcionamiento, o para escribir scripts sencillos.
...
espera encontrar un valor escalar ("en contexto escalar"), obtendrá el número
...
el ejemplo anterior, la última instrucción C<print $y> provocará una error en
