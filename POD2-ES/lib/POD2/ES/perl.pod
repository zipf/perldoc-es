...
más que estético (reducido, elegante, minimalista).
...
de los datos; si el sistema dispone de memoria suficiente, puede "succionar" un
...
para el procesamiento de texto, también incluye muchas herramientas
magníficas para procesar datos binarios.
...
logrado compilar perl, puede utilizar el script L<perlbug> del subdirectorio
