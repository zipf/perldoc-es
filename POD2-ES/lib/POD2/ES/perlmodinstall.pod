...
L<http://www.cpan.org/modules/04pause.html> y subir el código a CPAN. CPAN es la
abreviatura de I<Comprehensive Perl Archive Network>, una red de almacenamiento 
de recursos de Perl a la que se tiene acceso a través de L<http://www.cpan.org/> 
y en la que se pueden realizar búsquedas desde L<http://search.cpan.org/>.
...
Ejecute C<perl -MFoo -e 1>  (reemplace "Foo" por el nombre del módulo; por
...
C</mi/directorio_perl>. Para poder usar estos módulos en sus programas Perl,
