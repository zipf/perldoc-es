...
Por último, F<find2perl> traduce comandos C<find> en sus equivalentes Perl,
que usan el módulo L<File::Find|File::Find>. Por ejemplo, C<find2perl . -user
root -perm 4000 -print> genera la siguiente subrutina de devolución de llamada
para C<File::Find>:
...
archivos de configuración basados en Module::Build para características y
