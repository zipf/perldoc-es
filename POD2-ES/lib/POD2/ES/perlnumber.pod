...
una representación relativamente "corta" al convertirse en una fracción
binaria. Por ejemplo, 0.9 no se puede representar como un número de punto
flotante nativo porque la fracción binaria correspondiente a 0.9 es infinita:
...
Encontrará información detallada en L<"Operadores numéricos y conversiones
numéricas">.)
...
destino, se usa una representación del límite más cercano.  (I<Pérdida de
información>)
