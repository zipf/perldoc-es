...
disponible una revisión de FreeBSD libc (vea
...
hacía que, a veces, cualquiera de las dos formas mencionadas de obtener la ruta
devolviera un valor incorrecto (vea
