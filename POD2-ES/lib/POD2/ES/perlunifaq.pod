...
Se produce una descodificación implícita que no avisa y que se denomina
"promoción". Es posible que este nombre sugiera algo positivo, pero es mejor
evitar que suceda.
...
vea la descripción del modificador C<-C> en L<perlrun>.
