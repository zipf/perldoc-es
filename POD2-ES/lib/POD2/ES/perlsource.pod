...
publicado por separado en CPAN.

=item * F<cpan/>

Este directorio contiene módulos de evolución dual en los que el módulo de
CPAN es la versión canónica. No debe aplicar revisiones a estos módulos
...
envía una revisión, debe agregar su nombre a este archivo como parte de la
revisión.
