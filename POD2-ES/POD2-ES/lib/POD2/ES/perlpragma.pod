...
solo podíamos usar los pragmas prefinidos; ahora podemos crear pragmas de
...
manera parecida a C<use integer;>. Necesitamos algo así:
...
Es decir, cuando C<use entero;> está activo, se modifica el comportamiento
...
determinar el valor que tenía C<$^H{entero}> cuando se llamó a cada línea del
script del usuario y, por tanto, proporcionar la semántica correcta en la
