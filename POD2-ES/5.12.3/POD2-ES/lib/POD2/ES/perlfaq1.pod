...
Para obtener más información, consulte la nota personal que se incluye al final
 del archivo README de la distribución de código fuente de perl. En L<perlhist>
(nuevo desde la versión 5.005) está registrado el historial de lanzamiento de
versiones de Perl.
...
producir gratuitamente software de mejor calidad que el se podría obtener
...
flexibles en general que los de la las licencias de software GNU.
...
versión estable inmediatamente anterior. En la actualidad, éstas son perl5.12.x
y perl5.10.x respectivamente.
...
desbordamiento del búfer y, en algunos casos, notificaciones CERT (por ejemplo,
...
Actualmente nadie ofrece soporte para Perl 4 de forma activa. Hace cinco años
...
estará disponible cuando llegue el momento. Puede seguir su desarrollo, pero no
...
El número que va detrás de Perl (es decir, el 5 de Perl 5) es la versión
principal del intérprete de Perl (perl), así como la versión del lenguaje. Cada
...
Perl 6 es la siguiente versión principal de Perl, pero su sintaxis y su diseño
aún están en fase de desarrollo. El trabajo se inició en 2002 y sigue en curso.
Muchas de las características más interesantes de Perl 6 se han incluido en las
versiones más recientes de Perl 5, y algunos módulos de Perl 5 permiten usar la
sintaxis de Perl 6 en los programas. Puede obtener más información sobre Perl 6
en http://dev.perl.org/perl6/.
...
anunció que el desarrollo de Perl 6 iba a empezar a en serio. Perl 6 era un
...
do it" (o TMTOWTDI, pronunciado "tim toady"). Así, la curva de aprendizaje de
Perl tiene una pendiente suave (es fácil de aprender) y larga (si desea seguir
profundizando, puede aprender a hacer muchas cosas).
...
experimentos también allana en el aprendizaje.
...
orientados a un dominio de problema concreto, más cómodos para afrontar
...
subprocesos, aplicaciones complejas de memoria compartida y múltiples
subprocesos, o aplicaciones muy grandes. Notará que perl no está programado en
Perl.
...
Ésta es la razón por la que Tom dice que "perl sólo se puede analizar con
Perl".
...
inicial mayúscula para que destacara en la composición tipográfica. La
