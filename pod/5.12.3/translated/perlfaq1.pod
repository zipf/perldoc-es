...
El número que va detrás de Perl (es decir, el 5 de Perl 5) es la versión principal del intérprete perl, así como la versión del lenguaje. Cada versión principal incorpora diferencias importantes que no son compatibles con las versiones anteriores.
