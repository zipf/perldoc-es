...
time.  También puede subindexar una lista para obtener un solo elemento de ella.
...
simultaneously using a list of subscripts.  Es más conveniente que escribir los elementos individuales como una lista de valores escalares separados.
...
instead of a '%', think of it like this.  El tipo de carácter (corchete o llave) indica si se trata de un array o un hash.
...
Perl utiliza un tipo interno que se llama I<typeglob> para mantener una entrada entera en la tabla de símbolos.  El prefijo de un tipo de typeglob es una C<*>, porque representa todos los tipos.  This used to be the preferred way to
...
Ver L<perlsub> por ejemplos del uso de estos gestores indirectos de archivo en funciones.
