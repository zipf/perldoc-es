...
B<Descodificar> consiste en convertir I<binario> a I<texto>. Para descodificar necesita saber la codificación que se utilizó al codificar. También es fundamental que lo que se va a descodificar sea descodificable. No tiene sentido descodificar una imagen PNG en una cadena de texto.
...
Agregue al encabezado estándar de su programa la línea siguiente:

    use Encode qw(encode decode);

O, si no le sobra energía, puede limitarse a escribir esto:
...
Gracias a Gerard Goossen de TTY. Su presentación "UTF-8 in the wild" (Dutch Perl Workshop 2006) me sirvió de inspiración para publicar mis ideas y escribir este tutorial.
