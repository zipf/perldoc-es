...
No hay cambios intencionadamente incompatibles con 5.8.7. Si los hay, los fallos e informes serán bienvenidos.
...
1 fallo menor arreglado para Win32
...
La optimización de C<for (reverse @a)> introducido en perl 5.8.6 puede portarse mal cuando el array tuviera elementos indefinidos y fuera usado en contexto de IVALOR. Dave Mitchell proporcionó un arreglo.
...
=head2 No-cadenas pasadas como máscara de bits
...
=head2 Patrón de búsqueda no terminado u operador ternario interpretado como un patrón de búsqueda
