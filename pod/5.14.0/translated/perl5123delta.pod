...
perldelta - qué hay de nuevo en perl v5.12.3
...
Ahora puede usar las funciones incorporadas C<keys>, C<values>, C<each> con arrays (anteriormente sólo se podía utilizar con los hashes).  Véase L<perlfunc> para más detalles.
...
Las subrutinas ivalue pueden, nuevamente, devolver escalares por copia-en-escritura.  Esto se había roto desde la versión 5.10.0.
...
Para obtener más detalles y discusión sobre esto último, véase:
