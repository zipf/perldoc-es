...
Este documento describe las diferencias entre la versión 5.14.1 y la versión 5.14.2.

Si está actualizando desde una versión anterior como la 5.14.0, primero lea L<perl5141delta>, que describe las diferencias entre 5.40.0 y la 5.14.1.
...
L<CPAN> ha sido actualizado de la versión 1.9600 a la versión 1.9600_01.

L<CPAN::Distribution> ha sido actualizado de la versión 1.9602 a la 1.9602_01.
...
Localización de una variable ligada utilizada para que sea de sólo lectura si contenía una cadena copia-en-escritura.

=item *

Elementos de hashes restringidos (vea el I<pragma> L<fields>) que contenga valores de copia-en-escritura no se pudo eliminar, ni estos hashes podían ser limpiados (C<%hash = ()>).
