...
Este documentos describe varias características de Linux que afectarán a cómo Perl versión 5 (de ahora en adelante sólo Perl) es compilado y/o ejecutado.

=head2 Soporte Experimental para compiladores Sun Studio para sistemas operativos Linux

Sun Microsystems ha lanzado una versión de sus compiladores Sun Studio para Linux.  En noviembre de 2005, sólo ha sido lanzada una versión alfa.  
