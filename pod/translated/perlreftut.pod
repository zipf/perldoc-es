...
Este programa tiene dos partes: las líneas 2 a 7 leen la entrada y construyen una estructura de datos, y las líneas 8 a 13 analizan los datos e imprimen el informe.
...
Líneas 2 a 7 son responsables para la construcción de la estructura, al principio del programa.  Aquí están de nuevo:
