...
Ver L<perlsec/"Ataques de complejidad algorítmica"> para la justificación original de este cambio.
...
Algunos errores de sintaxis involucrados en no reconocer operadores de test de fichero son ahora manejados correctamente por el analizador.
