...
Cuando se utiliza ExtUtils::MakeMaker, puede usar "make dist" para crear el paquete.  Existen herramientas para ayudarle a construir su módulo en un estilo amigable, como MakeMaker.  Estos incluyen ExtUtils::ModuleMaker y h2xs.
