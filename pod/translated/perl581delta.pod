...
Si desea utilizar mod_perl 2.x. con Perl 5.8.1, necesitará mod_perl-1.99_10 o superior.  Las versiones anteriores de mod_perl 2.x no funcionan con la función de aleatorización de los hashes.  (mod_perl 1.x funciona bien.) También necesitará Apache::Test 1.04 o superior.
...
Si encuentra algo que piensa que es un error, debe revisar los artículos publicados recientemente en el grupo de noticias comp.lang.perl.misc y la base de datos de errores de perl en http://bugs.perl.org/ . Hay también información en la página principal de Perl, http://www.perl.org/ .
