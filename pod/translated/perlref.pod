...
No es posible crear una verdadera referencia a un gestor de E/S (gestor de archivo o gestor de directorio) utilizando el operador barra diagonal inversa.  Lo más que puede conseguir es una referencia a un I<typeglob>, que en realidad es una entrada en la tabla de símbolos.
