...
Por último, F<find2perl> traduce comandos C<find> en sus equivalentes Perl, que usan el módulo L<File::Find|File::Find>. Como un ejemplo, C<find2perl . -user root -perm 4000 -print> produce la siguiente subrutina para C<File::Find>:
