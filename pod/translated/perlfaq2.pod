...
I<The Perl Review> ( http://www.theperlreview.com ) se centra en Perl casi en exclusiva (aunque a veces incluye algún artículo sobre otro lenguaje). I<$foo Magazin> ( http://www.foo-magazin.de ) es una revista escrita en alemán dedicada a Perl.

I<Perl-Zeitung> es otra revista en alemán para programadores Perl principiantes (visite http://perl-zeitung.at.tf ).

Las revistas que suelen publicar artículos de calidad sobre Perl son I<The Perl Review> ( http://www.theperlreview.com ), I<Unix Review> ( http://www.unixreview.com/ ), I<Linux Magazine> ( http://www.linuxmagazine.com/ ) y la revista/boletín de noticias para los miembros de Usenix, I<login:> ( http://www.usenix.org/ ).
...
CPAN, o Comprehensive Perl Archive Network ( http://www.cpan.org/ ), es un repositorio de software Perl replicado en todo el mundo. Vea I<¿Qué es CPAN?> en L<perlfaq2>.
