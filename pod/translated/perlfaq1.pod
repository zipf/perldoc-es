...
El equipo que trabaja en la implementación actualmente más avanzada de Perl 6, Rakudo, publicó en julio de 2010 una distribución de Perl 6 "útil y utilizable, para pioneros", denominada Rakudo Star. Encontrará más información en L<http://rakudo.org/>.
...
La versión principal actual de Perl es Perl 5, y se lanzó en 1994. Permite ejecutar scripts de la versión principal anterior, Perl 4 (lanzada en marzo de 1991), pero incluye diferencias importantes.

Perl 6 es una reinvención de Perl. Es un lenguaje del mismo linaje, pero incompatible. Estos dos lenguajes no son mutuamente excluyentes, sino que se complementan. Perl 6 no sustituye a Perl 5, y viceversa. Vea L</"¿Qué es CPAN?"> a continuación para obtener más información.
...
Su desarrollo comenzó en 2002; actualmente se sigue trabajando en su sintaxis y diseño.
...
Si desea aprender más sobre Perl 6 o ayudarnos en nuestra cruzada por mejorar Perl, vea la página para programadores de Perl 6 en L<http://www.perl6.org/> e involúcrese.
...
Las versiones de producción, que incorporan correcciones de errores y funcionalidad nueva, se someten a pruebas intensivas antes de su lanzamiento. Tras el lanzamiento de la versión 5.000, lanzamos una versión de producción al año (en promedio).

Ocasionalmente, el equipo de desarrollo de Perl realizan cambios en los componentes internos del lenguaje, pero siempre se hace lo posible por mantener la compatibilidad con las versiones anteriores.
...
Al elegir un lenguaje también debe tener en cuenta los L<recursos|http://www.cpan.org/>, la L<cultura de testing|http://www.cpantesters.org/>
y la comunidad L<community|http://www.perl.org/community.html> del lenguaje.

Para comparar con un lenguaje específico, lo mejor suele ser crear un proyecto pequeño en ambos lenguajes y analizar los resultados. Asegúrese de usar todos los L<recursos|http://www.cpan.org/> de cada lenguaje, ya que un lenguaje es mucho más que la sintaxis.
...
Usted puede elegir adoptarla o no. Pero no debe escribir "PERL", ya que perl no es un acrónimo.
