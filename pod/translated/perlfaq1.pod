...
La versión principal actual de Perl es Perl 5, y se lanzó en 1994. Permite ejecutar scripts de la versión principal anterior, Perl 4 (lanzada en marzo de 1991), pero incluye diferencias importantes. Perl 5 incorpora referencias, complejas estructuras de datos y módulos. El intérprete de Perl 5 fue una reescritura completa del código fuente de perl.
...
Un bit. ¡Ah, no se refería a ASCII! :-) Larry usa "Perl" para designar el lenguaje y "perl" para designar su implementación (es decir, el intérprete). Ésta es la razón por la que Tom dice que "sólo perl puede analizar Perl".
