...
B<Nota:> Existe una gran cantidad de código que intenta solventar los históricos malos resultados de perl en la cuestión de las alternancias. A menudo, los trucos usados ??desactivarán estas nuevas optimizaciones. Esperemos que los módulos de apoyo utilizados para este propósito sean ajustados sobre estas nuevas optimizaciones para el momento en que v5.10 sea publicado.
