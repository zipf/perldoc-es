...
Haga algunos cambios, compile perl y compruebe sus cambios, entonces confírmelos en su rama local. Entonces ponga su rama local en una rama remota I<smoke-me>:
...
Ahora debería compilar perl y comprobar sus cambios (mezclados) una última vez (idealmente correrá todo el paquete de pruebas, fallando al menos en las pruebas F<t/porting/*.t>) antes de agregar sus cambios de la forma usual:
