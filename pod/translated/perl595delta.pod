...
La copia de la base de datos de caracteres Unicode incluidos en Perl 5.9 ha sido actualizado a la 5.0.0.
...
Las opciones C<-w> y C<-t> ahora se pueden utilizar en conjunto sin alterar qué categorías de alertas están activadas o no. (Rafael)
