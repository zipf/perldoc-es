...
Un metacarácter puede ser buscado poniendo una contrabarra delante de él:
...
Perl tiene varias abreviaturas para las clases de caracteres más comunes. (Estas definiciones son las que usa Perl en modo ASCII con el modificador C</a>.
