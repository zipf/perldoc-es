...
Las I<regexes> se tratan como si fueran cadenas doblemente entrecomilladas, así que la sustitución de variables funciona:
...
Los metacaracteres de B<agrupación> C<()> permite a una parte de una I<regex> que se trate como una unidad.  Partes de una I<regex> se agrupan encerrándolas entre paréntesis.  La regex C<gat(o|era)> significa que coincide con C<gat> seguido tanto por C<o> o C<era>.  Algunos ejemplos más
