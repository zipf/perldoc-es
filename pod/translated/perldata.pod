...
También debe hacer esto al interpolar una variable en una cadena para separar el nombre de una variable de un signo de dos puntos dobles o un apóstrofo, a fin de evitar que se traten como separadores de paquete:
X<interpolation> X<interpolación>
...
hace que $este::azul sea temporalmente un alias de $este::verde, pero no hace que @este::azul sea un alias de @ese::verde, o que %este::azul sea un alias de %este::verde, etc. Encontrará más ejemplos en la sección "Tablas de símbolos" de L<perlmod>.  Por extraño que pueda parecer, esta es la base de todo el sistema de importación/exportación de módulos.
