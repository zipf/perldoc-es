...
Como cambiando una porción cambia el array o hash original que se está troceando, una instrucción C<foreach> cambiará algunos -o incluso todos- los valores del array o hash.
