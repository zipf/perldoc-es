...
Presume todavía de tener algunas de las más poderosas expresiones regulares que puedan encontrarse, y su soporte para texto Unicode es de primera clase.  Maneja toda clase de texto estructurado, también, a través de una extensa colección de extensiones.  Esas bibliotecas, recogidas en CPAN, ofrece soluciones prefabricadas para una pasmosa variedad de problemas.  Cuando no crean sus propios estándares, los roban de los mejores -igual que el propio Perl-.
...
El pragma C<use warnings> produce algunos diagnósticos muy interesantes. También puede usar la bandera B<-w>, pero su uso está altamente desaconsejado, porque se aplica a todo código Perl que se ejecute, incluyendo el que no está bajo su control.
