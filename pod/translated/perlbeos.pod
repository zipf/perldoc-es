...
El test F<ext/POSIX/t/waitpid> falla en el número #1. Después de que todos los procesos hijo hayan terminado, el waitpid(-1, ...) devuelve 0 en lugar de -1 (como debería). No tengo idea de cómo solucionar este problema.
