...
En clases de caracteres entre corchetes, invertidas, Perl ignora las reglas Unicode que, normalmente dice que ciertos caracteres deben coincidir con una secuencia de caracteres múltiples bajo una coincidencia independiente del tamaño de caja C</i>.  Seguir esas reglas podría llevar a situaciones altamente confusas:
