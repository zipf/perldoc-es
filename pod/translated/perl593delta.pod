...
La sintaxis del comando C<-A> ha cambiado; ahora acepta un nombre de módulo opcional, siendo por defecto C<assertions::activate>. Vea L<aserciones> y L<perlrun>. (Escrito por Salvador Fandiño García.)

=head2 Unicode Character Database 4.1.0

La copia de la base de datos de caracteres Unicode incluidos en Perl 5.9 ha sido actualizada a la 4.1.0.
