...
Primero debe asegurarse de que el módulo no está instalado en el sistema.  Ejecute C<perl -MFoo -e 1>  (reemplace "Foo" por el nombre del módulo; por ejemplo, C<perl -MCGI::Carp -e 1>).
