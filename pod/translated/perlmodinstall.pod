...
Se concede permiso para realizar y distribuir copias literales de este documento siempre y cuando el aviso de copyright y este aviso de permiso se conserven en todas las copias.

Se concede permiso para copiar y distribuir versiones modificadas de esta documentación en las condiciones para la copia literal, siempre y cuando están marcadas claramente como versiones modificadas, que los nombres de los autores y el título no se hayan modificado (aunque los subtítulos y nombres de los autores adicionales pueden ser añadidos), y que todo el trabajo derivado resultante sea distribuido bajo los términos de una nota de permiso idéntica a ésta.

Se concede permiso para copiar y distribuir traducciones de este documento en otro idioma, bajo las condiciones anteriores para versiones modificadas.
