...
(Para ver las diferencias entre la versión 5.6.0 y la versión 5.7.0, vea L<perl570delta>.  (Para ver las diferencias entre la versión 5.7.0 y la versión 5.7.1, vea L<perl571delta>.  (Para ver las diferencias entre la versión 5.7.1 y la versión 5.7.2, vea L<perl572delta>).

=head1 Cambios

Esto es sólo una selección de algunos de los cambios más notables.
Los números se refieren a los números de cambio en el repositorio Perl; vea L<Changes58> (o L<Cambios> en Perl 5.8.1).  Además de estos cambios, mucho trabajo se llevó a cabo en la integración de I<threads>, PerlIO, y Unicode; limpieza general del código, y por último, pero no menos importante, portar a los no-Unix, tales como Win32, VMS, Cygwin, DJGPP, VOS, Mac OS Classic, y EBCDIC.
