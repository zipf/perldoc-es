...
=head2 La hoja
  ...
  CONTEXTO  SIGILOS ref        ARRAYS        HASHES
  ...
  []     array anónimo   ${$$foo[1]}[2] igual a $foo->[1]->[2]
  {}     hash anónimo    ${$$foo[1]}[2] igual a $foo->[1][2]
  \()    lista de ref.
  ...
  * / % x                SINTAXIS
  ...
  perl -V:ivsize  (?|p|p)reset ramas          \h  espacio horiz.
                  (?&NM) capt. con nombre     \R  rupt. línea
                                              \S \W \D \H negados
  LISTAS DE RETORNO DE FUNCIONES
...
L<http://perlmonks.org/?node_id=216602> - la publicación original en PM

=item *

L<http://perlmonks.org/?node_id=238031> - Versión Perl 6 de Damian Conway

=item *

L<http://juerd.nl/site.plp/perlcheat> - página de la chuleta Perl
