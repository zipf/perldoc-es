...
Ahora puede usar las funciones incorporadas C<keys>, C<values>, C<each> con arrays (anteriormente sólo se podía utilizar con los hashes).  Vea L<perlfunc> para más detalles.
