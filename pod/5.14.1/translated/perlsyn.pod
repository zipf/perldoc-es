...
Esto es algo equivalente a la funcionalidad de la sentencia C<switch> del C (no debe confundirse con la funcionalidad de I<Perl>; vea más adelante), en donde el mismo bloque se utiliza para varias declaraciones C<case>.
