...
A partir de ahora todas las aplicaciones que incrusten perl se comportarán como si se estuviera compilado con -DPERL_USE_SAFE_PUTENV.  Vea "Acceso al entorno" en el fichero F<INSTALL> para más detalles.
