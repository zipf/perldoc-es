...
Los nombres de los elementos que obtenemos del array empiezan por C<$> porque reciben valores individuales del array; si se pide un escalar, se obtiene un escalar. Para obtener varios elementos de un array:
...
incluidos en la instalación de Perl. Si desea escribir módulos de Perl, L<perlnewmod> le ayudará a empezar.
