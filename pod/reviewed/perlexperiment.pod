...
Estas funcionalidades ya no se consideran experimentales y se han suprimido. Si después de que le indicáramos explícitamente que estas funcionalidades no se deben usar en programas de producción decidió hacerlo, la responsabilidad es suya (vea L<perlpolicy>).
