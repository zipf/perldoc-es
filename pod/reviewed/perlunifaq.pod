...
Se produce una descodificación implícita que no avisa y que se denomina "promoción". Es posible que este nombre sugiera algo positivo, pero es mejor evitar que suceda.
...
En su ámbito léxico, este problema no debería producirse.  También se habilita automáticamente con C<use feature ':5.12'> o mediante el modificador C<-E> en la línea de comandos para Perl 5.12 o superior.
