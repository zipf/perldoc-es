...
En la actualidad, éstas son perl5.14.x y perl5.12.x respectivamente.
...
to do it" (o TMTOWTDI, que en inglés se pronuncia como "tim toady"). Así, la curva de aprendizaje de Perl tiene una pendiente suave (es fácil de aprender) y larga (si desea seguir profundizando, puede aprender a hacer muchas cosas).
